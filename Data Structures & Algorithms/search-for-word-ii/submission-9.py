...
class Solution:
    def findWords(self, board: List[List[str]], words: List[str]) -> List[str]:
        ...
        def dfs(r, c, node, word):
            ...
            # Pruning removes Trie branches once they can no longer produce any words, which shrinks the search space and lets DFS terminate early without missing valid results
            # Trie pruning = delete prefixes that no longer matter
